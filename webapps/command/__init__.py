from webapps import version
from webapps.command.init import init
from command.parse import parse
...
parser_init.add_argument('folder', default='DtCrawlAdmin', nargs='?', type=str, help='initial workspace folder')
